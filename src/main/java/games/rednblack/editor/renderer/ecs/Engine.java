...
import games.rednblack.editor.renderer.ecs.injection.CachedInjector;
import games.rednblack.editor.renderer.ecs.injection.Injector;
import games.rednblack.editor.renderer.ecs.utils.Bag;
import games.rednblack.editor.renderer.ecs.utils.EntityBuilder;
...
import static games.rednblack.editor.renderer.ecs.EngineConfiguration.ASPECT_SUBSCRIPTION_MANAGER_IDX;
import static games.rednblack.editor.renderer.ecs.EngineConfiguration.COMPONENT_MANAGER_IDX;
import static games.rednblack.editor.renderer.ecs.EngineConfiguration.ENTITY_MANAGER_IDX;
...
public class Engine {
	...
	/** Manages all entities for the engine. */
	private final EntityManager em;

	/** Manages all component-entity associations for the engine. */
	...
	/** Manages all aspect based entity subscriptions for the engine. */
	...
	/**
	 * Creates a engine without custom systems.
	 * <p>
	 * {@link EntityManager}, {@link ComponentManager} and {@link AspectSubscriptionManager} are
	 * available by default.
	 * </p>
	 * Why are you using this? Use {@link #Engine(EngineConfiguration)} to create a engine with your own systems.
	 */
	public Engine() {
	 ...
	 * </p>
	 * @see EngineConfigurationBuilder
	 * @see EngineConfiguration
	 */
	public Engine(EngineConfiguration configuration) {
		partition = new EngineSegment(configuration);
	 ...
	 * {@link EngineConfiguration#register(String, Object)} instead, or
	 * configure an {@link Injector}
	 *
	 * If you want a non-throwing alternative, use {@link #inject(Object, boolean)}
	 * @param target
	 * 		Object to inject into.
	 * 		throws {@link MundaneWireException} if {@code target} is annotated with {@link SkipWire}
	 * @see Wire for more details about dependency injection.
	 ...
	 * Inject dependencies on object.
	 *
	 * Will not if it is annotated with {@link Wire}.
	 *
	 * If you want to specify nonstandard dependencies to inject, use
	 * {@link EngineConfiguration#register(String, Object)} instead, or
	 * configure an {@link Injector}.
	 ...
	 * 		{@link SkipWire} and {@code failIfNotInjectable} is true
	 * @see Wire for more details about dependency injection.
	 * @see #inject(Object)
	 */
	 ...
	 * managed resources upon bringing the engine to an end.
	...
	/**
	 * Returns a manager that takes care of all the entities in the engine.
	...
	/**
	 * Returns a manager that takes care of all the components in the engine.
	 ...
	 * {@link EntitySubscription subscriptions} in the engine.
	 *
	...
	/**
	 * Delete the entity from the engine.
	 * @param e
	...
	/**
	 * Check if the provided entity is pending for remove.
	 *
	 * The entity is considered to be in a final state once invoked;
	 * adding or removing components from an entity scheduled for
	 * deletion will likely throw exceptions.
	 ...
	 * @param entityId
	 * 		the entity to check
	 * 	@return true if it's scheduled for removal
	 */
	public boolean isDeleted(int entityId) {
		return batchProcessor.isDeleted(entityId);
	}

	/**
	 * Create and return a new or reused entity instance. Entity is
	 * automatically added to the engine.
	 *
	 * @return entity
	 ...
	 * Entity is automatically added to the engine.
	 *
	 * Use {@link Entity#edit()} to set up your newly created entity.
	 *
	 * You can also create entities using:
	 * <ul>
	 *   <li>{@link EntityBuilder} Convenient entity creation. Not useful when pooling.</li>
	 ...
	 *
	 * You can also create entities using:
	 * - {@link EntityBuilder} Convenient entity creation. Not useful when pooling.
	 ...
	 * return an entity even if it isn't active in the engine.</em> Make sure to
	...
	/**
	 * Gives you all the systems in this engine for possible iteration.
	 * @return all entity systems in engine
	 */
	 ...
	 * @param type
	 * 		type of system
	 * @return instance of the system in this engine
	 */
	...
	protected void setInvocationStrategy(SystemInvocationStrategy invocationStrategy) {
		...
		invocationStrategy.setEngine(this);
	...
	/**
	 * @return Strategy used for invoking systems during {@link Engine#process()}.
	 */
	public <T extends SystemInvocationStrategy> T getInvocationStrategy() {
		return (T) invocationStrategy;
	}

	static class EngineSegment {
		...
		EngineSegment(EngineConfiguration configuration) {
	 ...
	 *
	 * @see EngineConfiguration#setAlwaysDelayComponentRemoval(boolean)
	 * @see EngineConfigurationBuilder#alwaysDelayComponentRemoval(boolean)
     */
