 ...
 * on repeated access.
 * This class only caches the state related to the {@link Wire} annotation of the field.
 * <p>
...
public class CachedField {
	...
	/**
	 * {@link WireType#WIRE} if the field is annotated with {@link Wire},
	 * {@link WireType#SKIPWIRE} if the field is annotated with {@link SkipWire},
	 * {@link WireType#IGNORED} otherwise.
	 */
	public final WireType wireType;

	/**
	 * If the field is annotated with {@link Wire}, this will contain the cached value of
	 * {@link Wire#name()}.
	 */
