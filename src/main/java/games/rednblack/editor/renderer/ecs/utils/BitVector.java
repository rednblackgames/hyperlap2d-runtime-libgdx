...
import games.rednblack.editor.renderer.ecs.ComponentManager;
import games.rednblack.editor.renderer.ecs.EntityManager;
 ...
 *
 * @see EntityManager#registerEntityStore(BitVector)
 */
public class BitVector {
	 ...
	 * @throws ArrayIndexOutOfBoundsException if index less 0 */
	...
	/** @param index the index of the bit
	 * @return whether the bit is set
	 * @throws ArrayIndexOutOfBoundsException if index less 0 or index >= words.length*/
	 ...
	 * {@link Engine#compositionId(int) compositionId}. The
