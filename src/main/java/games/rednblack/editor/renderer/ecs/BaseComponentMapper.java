...
public abstract class BaseComponentMapper<A extends Component> {
	 ...
	 * @param engine the engine that this component mapper should use
	 * @return a new mapper
	 */
	@SuppressWarnings("unchecked")
	public static <T extends Component> BaseComponentMapper<T> getFor(Class<T> type, Engine engine) {
		return engine.getMapper(type);
	}
