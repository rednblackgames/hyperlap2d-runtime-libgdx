...
import games.rednblack.editor.renderer.ecs.io.InputStreamHelper;
...
public class EngineSerializationManager extends BaseSystem {
	...
	public static abstract class ArtemisSerializer<T> {
		...
		protected ArtemisSerializer(Engine engine) {
			this.engine = engine;
		}
