...
import static com.badlogic.gdx.utils.reflect.ClassReflection.getMethod;
import static com.badlogic.gdx.utils.reflect.ClassReflection.isInstance;
...
public final class ReflectionUtil {
	...
	static public <T extends java.lang.annotation.Annotation> T getAnnotation(Class c, Class<T> annotationClass) {
		final Annotation declaredAnnotation = ClassReflection.getDeclaredAnnotation(c, annotationClass);
		return declaredAnnotation != null ? declaredAnnotation.getAnnotation(annotationClass) : null;
	}

	public static <T extends java.lang.annotation.Annotation> T getAnnotation(Field field, Class<T> annotationClass) {
		final Annotation declaredAnnotation = field.getDeclaredAnnotation(annotationClass);
		return declaredAnnotation != null ? declaredAnnotation.getAnnotation(annotationClass) : null;
	}
