 ...
 * are automatically updated during {@link Engine#process()}.
 *
...
public class EntitySubscription {
    ...
    EntitySubscription(Engine engine, Aspect.Builder builder) {
        extra = new SubscriptionExtra(builder.build(engine), builder);
