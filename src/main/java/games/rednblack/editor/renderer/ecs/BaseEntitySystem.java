...
import games.rednblack.editor.renderer.ecs.utils.reflect.SystemMetadata;

import static games.rednblack.editor.renderer.ecs.utils.reflect.ReflectionUtil.implementsAnyObserver;
...
public abstract class BaseEntitySystem extends BaseSystem
    ...
    public EntitySubscription getSubscription() {
        final AspectSubscriptionManager sm = engine.getAspectSubscriptionManager();
     ...
     * - {@link Engine#isAlwaysDelayComponentRemoval} is enabled to make accessing all components safe,
