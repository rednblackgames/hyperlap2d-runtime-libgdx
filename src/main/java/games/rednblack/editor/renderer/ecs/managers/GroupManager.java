package games.rednblack.editor.renderer.ecs.managers;
...
import games.rednblack.editor.renderer.ecs.utils.ImmutableIntBag;
 ...
 * <p>
 * You must retrieve it using engine instance.
 * </p>
 * <p>
...
public class GroupManager extends BaseSystem {
    ...
    protected void initialize() {
        engine.getAspectSubscriptionManager().get(all())
    ...
    public void add(final int entityId, String group) {
        final Entity e = engine.getEntity(entityId);
        add(e, group);
    }
    ...
    public void remove(final int entityId, String group) {
        remove(engine.getEntity(entityId), group);
    }
    ...
    public void remove(final int entityId, String g1, String g2) {
        remove(engine.getEntity(entityId), g1, g2);
    }
    ...
    public void remove(final int entityId, String g1, String g2, String g3) {
        remove(engine.getEntity(entityId), g1, g2, g3);
    }
    ...
    public void remove(final int entityId, String... groups) {
        remove(engine.getEntity(entityId), groups);
    }
    ...
    void deleted(IntBag entities) {
        ...
        for (int i = 0, s = entities.size(); s > i; i++) {
            removeFromAllGroups(engine.getEntity(ids[i]));
        }
    }
}
