 ...
 * Most basic system.
 *
 * Upon calling engine.process(), your systems are processed in sequence.
 *
 * Flow:
...
public abstract class BaseSystem {
	/** The engine this system belongs to. */
	@SkipWire
	...
	public boolean isEnabled() {
		return engine.invocationStrategy.isEnabled(this);
	}
	...
	public void setEnabled(boolean enabled) {
		engine.invocationStrategy.setEnabled(this, enabled);
	}
	...
	/**
	 * Get the engine associated with the manager.
	 *
