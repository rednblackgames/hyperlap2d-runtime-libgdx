...
public interface ArtemisPlugin {
	 ...
	 * - other plugins
	 *
	 * Always prefer to use {@link EngineConfigurationBuilder#dependsOn} as it can handle repeated dependencies,
	 * as opposed to {@link EngineConfigurationBuilder#with}, which will throw an exception upon attempting to
	 ...
	 */
	void setup(EngineConfigurationBuilder b);
}
