...
public class LightComponentFactoryV2 extends ComponentFactoryV2 {

    protected ComponentMapper<LightObjectComponent> lightObjectCM;

    private final EntityTransmuter transmuter;

    public LightComponentFactoryV2(com.artemis.World engine, RayHandler rayHandler, World world, IResourceRetriever rm) {
    ...
    public int getEntityType() {
        return EntityFactoryV2.LIGHT_TYPE;
    }
